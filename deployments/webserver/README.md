...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `image-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `image-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `image-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `image.sdkwork.com` | 443 ssl + 80 |
