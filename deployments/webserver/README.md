...
Module `sdkwork-image` · runtime code `image` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `image-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `image-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `image-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `image-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `image.sdkwork.com` | 443 ssl + 80 |
