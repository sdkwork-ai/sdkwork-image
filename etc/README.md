# sdkwork-image Source Configuration
...
| `appId` | `sdkwork-image` |
| `runtimeCode` | `image` |
| Config root | `/etc/sdkwork/image/` |
| Runtime TOML | `/etc/sdkwork/image/config.toml` |
| Secrets | `/etc/sdkwork/image/secrets/` |
| Override | `SDKWORK_IMAGE_CONFIG_FILE` |
