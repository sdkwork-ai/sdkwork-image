# Runbook — sdkwork-image deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-image-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-image/bundle`, loads the image, starts
